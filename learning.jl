...
=#
type AdaBoostLearner
    h::AbstractVector
    z::AbstractVector
    hypothesis::Function

    function AdaBoostLearner(dataset::DataSet, L, K::Int64)
...
"""
    adaboost!(abl::AdaBoostLearner, dataset::DataSet, L, K::Int64)
...
"""
function adaboost!(abl::AdaBoostLearner, dataset::DataSet, L, K::Int64)
